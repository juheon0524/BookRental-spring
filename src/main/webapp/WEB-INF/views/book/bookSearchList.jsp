        ...
        <div class="shareContentWrap">
            <div class="shareNav">
                <ul>
                    ...
                    <li><span class="keyword">통합도서 검색</span></li>
            ...
            <div class="shareContentBox">
                <div class="shareContentTitle">
                    <div class="contentTitle">통합도서 검색</div>
                ...
                <div class="shareContent">
                        ...
                        <div class="listImgBox">
	                        <c:choose>
								<c:when test="${empty book.bookimgurl }">
									<img src="/resources/image/noimage.gif"  alt="검색도서">
								</c:when>
								<c:when test="${fn:contains(book.bookimgurl, 'https')}">
						            <!-- If bookimgurl contains 'https', specify a different image URL -->
						            <img src="${book.bookimgurl }" alt="검색도서">
						        </c:when>
								<c:otherwise>
									<img src="/resources/image/${book.bookimgurl }" alt="검색도서">
								</c:otherwise>
							</c:choose>
                        </div>
                	...
                	<ul class="bookListPage">
						<li><c:choose>
								...
								<c:otherwise>
									<a href="BookServlet?command=book_slist&page=${paging.page-1}">[이전]</a>&nbsp;
			          			</c:otherwise>
								...
								<c:choose>
									...
									<c:otherwise>
										<a href="BookServlet?command=book_slist&page=${a}">[${a}]</a>&nbsp;
			               			</c:otherwise>
								</c:choose>
							</c:forEach> <c:choose>
								...
								<c:otherwise>
									<a href="BookServlet?command=book_slist&page=${paging.page+1}">[다음]</a>
								</c:otherwise>
							</c:choose></li>
					</ul>               	    
